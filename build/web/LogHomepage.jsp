...
<html>
  ...
  %> 
        <div class="header">
            ...
            <a href="LogHomepage.jsp" class="phome" style="width: 100px;">
	...
	<div class="sidenav">
            ...
            <a id="atag" class="atag">
                <% 
                   try{String s=session.getAttribute("user").toString();
                   out.println(s);}
                   catch(NullPointerException npe){}
                %>
            </a>
            <a id="btag" class="atag">Cart Id:
               <span>
                <%
                    try
                    {
            ...
            <a class="atag" href="myorder.jsp"><li><i class=''></i>My Orders</li></a>
...
<!--Slide show-->                  
        ...
        <footer class="footer" style="padding: 2%; overflow: hidden;">
            <table class="footertab" style="width: 100%; font-family: sans-serif; font-size: small; font-weight: bold; text-align: center; padding: 20px 150px 20px 20px;">
                <tr>
