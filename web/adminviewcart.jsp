...
<html>
	...
	<div class="header">
        ...
        <div class="search">
            ...
            <a href="adminlogpage.jsp" id="phome" style="width: 100px;">
        ...
        <div class="cart">
           ...
           %>
            ...
            <tr>
                ...
                <td>&nbsp;</td>
                <td>
                <input style="border: none; cursor: pointer; width: 100%; height: 30px; background-color: hotpink;" type="submit" id="send" value="Check Out"/>
                </td>
